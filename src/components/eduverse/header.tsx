...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-4 flex justify-between items-center w-full pointer-events-none">
      <Sheet>
        <SheetTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full bg-black/20 hover:bg-black/30 text-white backdrop-blur-sm pointer-events-auto"

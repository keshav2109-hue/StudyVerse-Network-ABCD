...
export function middleware(request: NextRequest) {
  // Paths to protect
  const protectedPaths = ['/pcmb', '/commerce', '/edu10', '/edu9', '/live', '/subjects', '/verifieduser'];
...
export const config = {
  matcher: ['/pcmb/:path*', '/commerce/:path*', '/edu10/:path*', '/edu9/:path*', '/live/:path*', '/subjects/:path*', '/verifieduser/:path*'],
};
